...
namespace Frank.TorrentClient.Tests.Legacy;
...
public class TorrentInfoTest
{
    ...
    public void TorrentInfo_TryLoad()
    {
        ...
        filePath = @"./Files/test_folder-d984f67af9917b214cd8b6048ab5624c7df6a07a.torrent";
        ...
        if (TorrentInfo.TryLoad(filePath, out info))
        {
            ...
            foreach (var hash in info.PieceHashes) Assert.IsTrue(regex.IsMatch(hash));
        }
        else
        {
