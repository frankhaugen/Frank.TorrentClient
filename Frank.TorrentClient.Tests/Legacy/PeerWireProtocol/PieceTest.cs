...
namespace Frank.TorrentClient.Tests.Legacy.PeerWireProtocol;
...
public class PieceTest
{
    ...
    {
        Piece piece;
        var pieceHash = "b6 a2 8b cf cc aa be 37 c3 ea e0 73 c6 d9 f2 a0 4b 46 70 89".Replace(" ", string.Empty)
            .ToByteArray();
        byte[] pieceData;
        var block0Data = new byte[4];
        var block1Data = new byte[4];
        var block2Data = new byte[4];
        var block3Data = new byte[4];
        ...
        piece.Completed += (sender, e) =>
        {
            ...
            CollectionAssert.AreEqual(new[] { true, true, true, true }, piece.BitField);
        };
        piece.Corrupted += (sender, e) => { Assert.Fail(); };
        ...
        Assert.AreEqual(6, piece.PieceIndex);
        Assert.AreEqual(16, piece.PieceData.Length);
        CollectionAssert.AreEqual(new[] { false, false, false, false }, piece.BitField);
        ...
        Assert.AreEqual(6, piece.PieceIndex);
        Assert.AreEqual(16, piece.PieceData.Length);
        CollectionAssert.AreEqual(new[] { true, false, false, false }, piece.BitField);
        ...
        Assert.AreEqual(6, piece.PieceIndex);
        Assert.AreEqual(16, piece.PieceData.Length);
        CollectionAssert.AreEqual(new[] { true, true, false, false }, piece.BitField);
        ...
        Assert.AreEqual(6, piece.PieceIndex);
        Assert.AreEqual(16, piece.PieceData.Length);
        CollectionAssert.AreEqual(new[] { true, true, true, false }, piece.BitField);
    ...
    {
        Piece piece;
        var pieceHash = "b6 a2 8b cf cc aa be 27 c3 ea e0 73 c6 d9 f2 a0 4b 46 70 89".Replace(" ", string.Empty)
            .ToByteArray();
        byte[] pieceData;
        var block0Data = new byte[4];
        var block1Data = new byte[4];
        ...
        piece = new Piece(6, pieceHash.ToHexaDecimalString(), 16, 4, 4);
        piece.Completed += (sender, e) => { Assert.Fail(); };
