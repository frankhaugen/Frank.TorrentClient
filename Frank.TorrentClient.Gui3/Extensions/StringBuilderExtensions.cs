...
{
    public static StringBuilder AppendWithTrailingSpace(this StringBuilder source, string value) => source.Append(value).Append(" ");

    public static StringBuilder AppendSurroundedBy(this StringBuilder source, char prefix, string value, char suffix) => source.Append(prefix).Append(value).Append(suffix);

    public static StringBuilder AppendIndented(this StringBuilder source, string value, int indents = 0) => source.Append(Helpers.Indent(indents)).Append(value);
